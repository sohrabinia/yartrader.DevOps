...
using TradeYar.DevOps.Core.Modules;
using TradeYar.DevOps.Core.Logging;

namespace TradeYar.DevOps.Api.Controllers
{
    [ApiController]
    [Route("api/devops")]
    public class DevOpsController : ControllerBase
    {
        ...
        private static readonly List<string> _simulatedEvents = new()
        {
            ...
            "Profile 'tradeyar-production' loaded.",
        ...
        public IActionResult GetModules()
        {
            ...
            {
                new() { Name = "TradeYar.DevOps.Core", IsLoaded = true, Version = "1.0.0" },
                new() { Name = "TradeYar.DevOps.Infrastructure", IsLoaded = true, Version = "1.0.0" },
                new() { Name = "TradeYar.DevOps.Shared", IsLoaded = true, Version = "1.0.0" }
            };
