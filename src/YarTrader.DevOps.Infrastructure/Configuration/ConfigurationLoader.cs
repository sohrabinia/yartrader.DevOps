...
namespace YarTrader.DevOps.Infrastructure.Configuration
{
    public class PlatformConfig
    {
        public string Name { get; set; } = "YarTrader AI";
    ...
    public class ConfigurationLoader
    {
        ...
        public DevOpsConfiguration LoadConfiguration(string configDir, string profileDir = "")
        {
            ...
            try
            {
                ...
                {
                    var profilePath = Path.Combine(profileDir, "YarTrader-production.yaml");
