...
namespace YarTrader.DevOps.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                serviceOptions.ServiceName = "YarTrader-DevOps";
            });
            ...
            builder.Services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "YarTrader.DevOps.Api",
                    Version = "v1",
                    Description = "YarTrader AI DevOps foundation platform API."
                });
            });
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "YarTrader.DevOps.Api v1");
